...
@section('content')
        ...
        <div class="col-sm-6">
            ...
            {!! Form::model($reservation,['route' => 'reservations.reserve_check']) !!}
                ...
                <div class="form-group d-flex flex-row">
                    <div>{!! Form::label('reserve_date', '貸出期間：') !!}</div>
    ...
    {{-- ページネーションのリンク --}}
    {{ $reservations_confirm->appends(request()->query())->links() }}
